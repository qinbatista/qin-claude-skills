...
This process authority guides writing before and during the change. The lifecycle's memory step (`SKILL.md` section 8) records sanitized, verified outcomes only after independent verification PASS. Neither substitutes for the other.
