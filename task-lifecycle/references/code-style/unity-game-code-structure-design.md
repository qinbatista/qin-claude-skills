...
- This reference governs the writing process. The lifecycle's memory step (`SKILL.md` section 8) records only the sanitized verified result after verification; result memory never replaces this process gate.
